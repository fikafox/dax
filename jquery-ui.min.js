            ...
            flip: {
                left: function (t, e) {
                    ...
                    0 > c
                        ...
                        : u > 0 && ((s = t.left - e.collisionPosition.marginLeft + d + p + f - l), (s > 0 || u > r(s)) && (t.left += d + p + f));
                },
                top: function (t, e) {
                    var i,
                        s,
                        ...
                        g = -2 * e.offset[1];
                    0 > c
                        ? ((s = t.top + p + f + g + e.collisionHeight - o - a), t.top + p + f + g > c && (0 > s || r(c) > s) && (t.top += p + f + g))
                        : u > 0 && ((i = t.top - e.collisionPosition.marginTop + p + f + g - l), t.top + p + f + g > u && (i > 0 || u > r(i)) && (t.top += p + f + g));
                },
            },
            flipfit: {
                left: function () {
    ...
    e.widget("ui.button", {
        ...
        _resetButton: function () {
            ...
            s.primary || s.secondary
                ? (this.options.text && o.push("ui-button-text-icon" + (a ? "s" : s.primary ? "-primary" : "-secondary")),
                  ...
                  this.options.text || (o.push(a ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || t.attr("title", e.trim(i))))
    ...
    e.widget("ui.dialog", {
        ...
        _setOption: function (e, t) {
            ...
            "dialogClass" === e && s.removeClass(this.options.dialogClass).addClass(t),
                "disabled" !== e &&
                    ...
                    "draggable" === e && ((i = s.is(":data(ui-draggable)")), i && !t && s.draggable("destroy"), !i && t && this._makeDraggable()),
                    "position" === e && this._position(),
                    "resizable" === e && ((a = s.is(":data(ui-resizable)")), a && !t && s.resizable("destroy"), a && "string" == typeof t && s.resizable("option", "handles", t), a || t === !1 || this._makeResizable()),
        ...
        _size: function () {
            ...
            this.element.show().css({ width: "auto", minHeight: 0, maxHeight: "none", height: 0 }),
                ...
                "auto" === a.height ? this.element.css({ minHeight: t, maxHeight: i, height: "auto" }) : this.element.height(Math.max(0, a.height - e)),
        ...
        _generatePosition: function (e) {
            ...
            return (
                ...
                this.originalPosition &&
                    ...
                    o.grid &&
                        ((n = o.grid[1] ? this.originalPageY + Math.round((h - this.originalPageY) / o.grid[1]) * o.grid[1] : this.originalPageY),
            ...
            drag: function (e, i) {
                ...
                for (u = p.snapElements.length - 1; u >= 0; u--)
                    (r = p.snapElements[u].left),
                        ...
                        r - f > _ || m > l + f || h - f > b || v > c + f || !t.contains(p.snapElements[u].item.ownerDocument, p.snapElements[u].item)
                            ? (p.snapElements[u].snapping && p.options.snap.release && p.options.snap.release.call(p.element, e, t.extend(p._uiHash(), { snapItem: p.snapElements[u].item })), (p.snapElements[u].snapping = !1))
                            : ("inner" !== g.snapMode &&
                                  ((s = f >= Math.abs(h - b)),
                                  (n = f >= Math.abs(c - v)),
                                  (a = f >= Math.abs(r - _)),
                                  ...
                                  n && (i.position.top = p._convertPositionTo("relative", { top: c, left: 0 }).top - p.margins.top),
                                  a && (i.position.left = p._convertPositionTo("relative", { top: 0, left: r - p.helperProportions.width }).left - p.margins.left),
                              ...
                              "outer" !== g.snapMode &&
                                  ...
                                  n && (i.position.top = p._convertPositionTo("relative", { top: c - p.helperProportions.height, left: 0 }).top - p.margins.top),
                              ...
                              !p.snapElements[u].snapping && (s || n || a || o || d) && p.options.snap.snap && p.options.snap.snap.call(p.element, e, t.extend(p._uiHash(), { snapItem: p.snapElements[u].item })),
            ...
            (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
                ...
                (c.hsla.to = function (t) {
                    ...
                    var e,
                        ...
                        u = 0.5 * c;
                    return (
                        (e = l === r ? 0 : s === r ? (60 * (n - a)) / h + 360 : n === r ? (60 * (a - s)) / h + 120 : (60 * (s - n)) / h + 240),
                                ...
                                (h.fn[e] = function (n) {
                                    ...
                                    return "undefined" === o
                                        ...
                                        : ("function" === o && ((n = n.call(this, c)), (o = t.type(n))),
                                          null == n && i.empty ? this : ("string" === o && ((a = r.exec(n)), a && (n = c + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))), (h[i.idx] = n), this[l](h)));
                                });
                        });
                }),
                (h.hook = function (e) {
...
(function (t) {
    (t.effects.effect.puff = function (e, i) {
        ...
        t.extend(e, { effect: "scale", queue: !1, fade: !0, mode: n, complete: i, percent: a ? o : 100, from: a ? l : { height: l.height * r, width: l.width * r, outerHeight: l.outerHeight * r, outerWidth: l.outerWidth * r } }),
            s.effect(e);
    }),
        (t.effects.effect.scale = function (e, i) {
            ...
            (n.effect = "size"),
                ...
                (n.from = e.from || ("show" === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : h)),
                (n.to = { height: h.height * c.y, width: h.width * c.x, outerHeight: h.outerHeight * c.y, outerWidth: h.outerWidth * c.x }),
        ...
        (t.effects.effect.size = function (e, i) {
            ...
            "show" === p && o.show(),
                ...
                ("box" === g || "both" === g) &&
                    (a.from.y !== a.to.y && ((_ = _.concat(u)), (o.from = t.effects.setTransition(o, u, a.from.y, o.from)), (o.to = t.effects.setTransition(o, u, a.to.y, o.to))),
...
(function (t) {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStart: function (i) {
            ...
            return (
                (this.resizing = !0),
                /absolute/.test(h.css("position")) ? h.css({ position: "absolute", top: h.css("top"), left: h.css("left") }) : h.is(".ui-draggable") && h.css({ position: "absolute", top: r.top, left: r.left }),
                this._renderProxy(),
        ...
        t.ui.plugin.add("resizable", "containment", {
            ...
            resize: function (e) {
                ...
                d[0] !== document && /static/.test(d.css("position")) && (u = h),
                    l.left < (o._helper ? h.left : 0) &&
                        ((o.size.width = o.size.width + (o._helper ? o.position.left - h.left : o.position.left - u.left)), c && (o.size.height = o.size.width / o.aspectRatio), (o.position.left = r.helper ? h.left : 0)),
            ...
            stop: function () {
                ...
                e._helper && !i.animate && /relative/.test(a.css("position")) && t(this).css({ left: r.left - n.left - s.left, width: h, height: l }),
                    e._helper && !i.animate && /static/.test(a.css("position")) && t(this).css({ left: r.left - n.left - s.left, width: h, height: l });
            },
        }),
            ...
            resize: function () {
                ...
                (i.grid = r),
                    ...
                    /^(se|s|e)$/.test(o)
                        ...
                        : (p - l > 0 ? ((e.size.height = p), (e.position.top = a.top - u)) : ((e.size.height = l), (e.position.top = a.top + n.height - l)),
                          d - h > 0 ? ((e.size.width = d), (e.position.left = a.left - c)) : ((e.size.width = h), (e.position.left = a.left + n.width - h)));
            },
        });
})(jQuery);
(function (t) {
